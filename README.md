...
New to AeroTrixi.jl? The [Getting started](docs/src/getting_started.md) tutorial walks through a complete simulation of a supersonic flow around an airfoil,
